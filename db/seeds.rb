...
#  
I18n.locale = :en
Ambassador.create(firstname: "Sébastien", lastname: "Bras", source_id: 1544, company_name: "Bras", mailer_summary: "En réservant dans notre établissement, vous venez d’offrir la possibilité à des enfants népalais de manger un repas chaud par jour dans leur école", mailer_description: "")
...
Ambassador.create(firstname: "Olivier", lastname: "Leroux", source_id: 4544, company_name: "Paul Bocuse - Collonges", mailer_summary: "", mailer_description: "L’initiative s’inscrit parfaitement dans les valeurs que nous souhaitons véhiculer : Partage, Transmission et Solidarité.
